...
with open('EIA_CO2_Electricity_2015.csv', 'r') as csvfile:
    cur.execute("CREATE TABLE electricity( MSN varchar(20), YYYYMM int, Value varchar(13));")    
    cur.execute("CREATE TABLE electricity_misc(MSN varchar(20), Column_Order varchar(2), Description varchar(100), Unit varchar(39));")
