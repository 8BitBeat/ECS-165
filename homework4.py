...
with open('HHV2PUB.CSV', 'r') as csvfile:
    print"hh"
...
with open('VEHV2PUB.CSV', 'r') as csvfile:
    ...
    #     count += 1
    #     for element in row:
    #         if element == 'XXXX' or element == 'XXXXX' or element == 'XXX':
    #             element = -2
    #         if inc == 12 or inc == 39 :
    #             query += "'" + str(element) + "', "  
    #         else:
...
with open('PERV2PUB.CSV', 'r') as csvfile:
    ...
    for row in reader:
        ...
        for element in row:
            if element == 'XXXX' or element == 'XXXXX':
                element = -2
            if inc == 32 or inc == 44 or inc == 100:
                query += "'" + str(element) + "', "  
            else:
                query += str(element) +', '
            inc +=1
